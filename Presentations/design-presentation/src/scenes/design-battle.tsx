import {makeScene2D, Rect, Img, Txt, Line, Polygon} from "@motion-canvas/2d"
import {all, beginSlide, createRef, createSignal, makeRef, useScene, Vector2} from "@motion-canvas/core"
...
export default makeScene2D(function* (view) {
    ...
    view.add(
        <Rect ref={wrapper} width={'100%'} height={'100%'} fill={DARK} >
            ...
            <Rect width={'80%'} height={'40%'} y={-50}>
                ...
                <EdgeStrokeTxt ref={bottomText} text={'Nodes'} fill={'white'} y={100} {...headerProps}/>
            </Rect>
    ...
    yield* all(
        ...
        bottomText().text('Battle', 1),
    );

    yield* beginSlide('start');

    yield* beginSlide('battle loop');
    yield* all(
